    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen min-h-[600px] flex items-start justify-start overflow-hidden">
        <video
          ...
          loop
          playsInline
          className="absolute inset-0 w-full h-full object-cover object-right md:object-right max-md:object-[75%_center]"
        />
        <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-black/70 to-transparent z-[5]" />
        <div className="relative z-10 flex flex-col items-center text-center px-5 md:px-16 pt-6 md:pt-16 animate-fade-up">
          <img
            src={logo}
            alt="Bakaus logo"
      ...
      <footer className="py-10 text-center text-muted-foreground text-sm font-body border-t border-border space-y-1">
        ...
        <p><a href="mailto:hadiikhsan104@gmail.com" className="underline hover:text-foreground transition-colors">hadiikhsan104@gmail.com</a></p>
